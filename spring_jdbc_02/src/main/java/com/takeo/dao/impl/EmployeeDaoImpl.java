...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public String getEname(int eno) {
		return jt.queryForObject("SELECT ename FROM employee WHERE eno=?", new Object[] {Integer.valueOf(eno)}, String.class);
	}
	...
	public Map getEmployeeDetails(int eno) {
		return jt.queryForMap("SELECT * FROM employee WHERE eno=?", Integer.valueOf(eno));
	}
